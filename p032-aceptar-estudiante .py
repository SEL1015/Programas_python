...
if edad < 18:
        ...
        print("Proceso Terminado , gracias por participar ")
else:
...
if calificacion1 < 8 or calificacion2 < 8:
    print(f' Lo sentimos,{nombre} se requiere una calificación mínima de 8 en ambos exámenes.')
else:
# Si ambas condiciones (edad y calificaciones) se cumplen
    print(f' ¡Bienvenid@  a la Universidad , {nombre}! Tu edad de {edad} y tus calificaciones te permiten ingresar.')